...
First, **fork** [this repo](https://github.com/AY2425S2-CS2103-F15-2/tp), and **clone** the fork into your computer.
...
1. **Do the tutorials**
   These tutorials will help you get acquainted with the AB3 codebase (Slightly different from TutorSynch's codebase).
