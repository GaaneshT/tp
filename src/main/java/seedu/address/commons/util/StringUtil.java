...
public class StringUtil {
    ...
    /**
     * Returns true if {@code s} represents a valid date
     * e.g. 13-01-2025, 14-11-2000, ..., etc. <br>
     * Will return false for any other invalid date format
     * e.g. 2000-01-20, 2000-20-01, etc.
     * @throws NullPointerException if {@code s} is null.
     */
