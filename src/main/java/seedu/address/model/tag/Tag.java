...
public class Tag {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Tags names should be alphanumeric with no spaces and no more "
            + "than 10 characters long, while its color codes should be 6 hexadecimal long (e.g. \"CS2040C#F2552E\")";
